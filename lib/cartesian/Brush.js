  ...
  function Brush(props) {
    ...
    _this.handleSlideDragStart = function (e) {
      ...
      _this.setState({
        isTravellerMoving: false,
        isSlideMoving: true,
        slideMoveStartX: _this.props.verticalLayout ? event.pageY : event.pageX
      });
  ...
  _createClass(Brush, [{
    ...
    value: function handleSlideDrag(e) {
      ...
      var _this$props4 = this.props,
          ...
          verticalLayout = _this$props4.verticalLayout;
      var delta = (verticalLayout ? e.pageY : e.pageX) - slideMoveStartX;
    ...
    value: function handleTravellerMove(e) {
      ...
      var _this$props5 = this.props,
          ...
          verticalLayout = _this$props5.verticalLayout;
      var params = {
        startX: this.state.startX,
        endX: this.state.endX
      };
      var delta = (verticalLayout ? e.pageY : e.pageX) - brushMoveStartX;
      ...
      this.setState((_this$setState = {}, _defineProperty(_this$setState, movingTravellerId, prevValue + delta), _defineProperty(_this$setState, "brushMoveStartX", verticalLayout ? e.pageY : e.pageX), _this$setState), function () {
        if (onChange) {
          if (isFullGap()) {
            onChange(newIndex);
          }
    ...
    value: function renderTravellerLayer(travellerX, id) {
      var _this$props8 = this.props,
          ...
          verticalLayout = _this$props8.verticalLayout;
      var x = Math.max(travellerX, this.props.x);

      var travellerProps = _objectSpread({}, (0, _types.filterProps)(this.props), {
        x: x,
        y: y,
    ...
    value: function render() {
      var _this$props11 = this.props,
          ...
          verticalLayout = _this$props11.verticalLayout;
      ...
      if (verticalLayout) style = _objectSpread({}, style, {
